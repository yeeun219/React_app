...
const columns = ['id','type', 'r_date', 'r_time', 'product_name','produc_code','account_number','isDifficult','kb_pin','c_name','is_old','branch_name','branch_code','e_name','e_num','isExcept','isOpinion','addrecord','plusrecord','ischeck'];
const options = {
    headings: {id: '#'},
